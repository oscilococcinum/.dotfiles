{
  inputs = {
    ...
    freecad-weekly-appimage-x86_64-linux.url = "https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_weekly-builds-39416-conda-Linux-x86_64-py311.AppImage";
