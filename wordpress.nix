  ...
  services = {
    ...
    wordpress = {
      ...
      sites."${domain}" = {
	    ...
	    inherit (pkgs.wordpressPackages.plugins) wpforms-lite; 
	    inherit (pkgs.wordpressPackages.plugins) wp-mail-smtp;
	    inherit (pkgs.wordpressPackages.plugins) static-mail-sender-configurator;
	};
